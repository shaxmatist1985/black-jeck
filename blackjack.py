...
class BJ_Hand(cards.Hand):
    ...
    def total(self):
        ...
        if contains_ace and t >= 11:
            # прибавить нужно лиш 10, потому что единица уже вошла в общую сумму
            t += 10
        return t
    def is_busted(self):
...
class BJ_Game(object):
    ...
    def play(self):
        ...
        self.dealer.flip_first_card()# первая из карт, сданных дилеру, переворачивается рубашкой верх
        for player in self.players:
            print(player)
        print(self.dealer)
        ...
        if not self.still_playing:
            ...
            if self.dealer.is_busted():
                #выгрывают все кто остался в игре
...
def main():
    ...
    names =[]
    number = games.ask_number('Сколько всего игрков?(1-7):', low =1, high = 8)
